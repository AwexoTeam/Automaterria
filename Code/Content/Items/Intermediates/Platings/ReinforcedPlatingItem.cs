...
{
    public class ReinforcedPlatingItem : ModItem
    {
        public override string Texture => "Automaterria/Assets/Items/ReinforcedPlatingItem";
        public override string Name => "ReinforcedPlating";
        ...
        public static int tileid
        {
            get
            {
                ...
                _tileid = ModContent.ItemType<ReinforcedPlatingItem>();
                return _tileid;
            }
        }
        ...
        {
            int item1 = ItemID.CobaltBar;
            int item2 = ItemID.OrichalcumBar;
