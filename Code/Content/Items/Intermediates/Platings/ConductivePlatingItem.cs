...
{
    public class ConductivePlatingItem : ModItem
    {
        public override string Texture => "Automaterria/Assets/Items/ConductivePlatingItem";
        public override string Name => "ConductivePlating";
        ...
        public static int tileid
        {
            get
            {
                ...
                _tileid = ModContent.ItemType<ConductivePlatingItem>();
                return _tileid;
            }
        }
        ...
        {
            int item1 = ItemID.PlatinumBar;
            int item2 = ItemID.GoldBar;
